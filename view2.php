...
<tr>
  ...
  <th style='text-align:center;'>Hormon T3</th>
  <th style='text-align:center;'>Hormon T4</th>
</tr>
...
<?php
      ...
      for ($i=0; $i <1 ; $i++) { 
        ...
        echo "<td style='text-align:center;'>".$data['T3']."</td>";
        echo "<td style='text-align:center;'>".$data['T4']."</td>";    
        echo "</tr>";
...
$pdf->WriteHTML($html);
$pdf->Output('Hasil Pemeriksaan Endokrinologi.pdf', 'D');
?>