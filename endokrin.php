...
<form action="endokrin_p.php" method="post">
<td>
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="kode_periksa" value="Hormon dan Endokrin" class="form-control" style="width:300px;">
    </div>
    <br>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="T3" class="form-control" style="width:500px;">
    ...
    <div class="form-group">
      ...
      <input type="text" name="T4" class="form-control" style="width:500px;">
    </div>
  <br>
  <button type="SUBMIT" name="submitee" class="btn btn-primary">OKE</button>
</td>
</form>
	</table>		
			</div>
