...
<html>
			...
			<div class="wrapper">
				...
				<nav id="sidebar">
					...
					<ul class="list-unstyled CTAs">
						<br><br><br>
						<li><a href="endokrin_e.php?page=logout" class="article">Logout</a></li>
 ...
 <?php 
  include ('koneksi.php');
  $no = $_GET['no'];
  $query_mysql = mysql_query("SELECT * FROM endokrin WHERE no='$no'")or die(mysql_error());
...
<td>
    ...
    <div class="form-group">
      <label >Hormon T3:</label>
      <input type="text" value="<?php echo $data['T4']?>" name="T3" class="form-control" style="width:500px;">
    </div>
    <div class="form-group">
      <label >Hormon t4:</label>
      <input type="text" value="<?php echo $data['T3']?>" name="T4" class="form-control" style="width:500px;">
    </div>
  <br>
  <button type="SUBMIT" name="endokrin" class="btn btn-primary">OKE</button>
</td>
</form>
	</table>		
			</div>
