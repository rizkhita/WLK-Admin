			...
			<div class="wrapper">
				...
				<nav id="sidebar">
					...
					<ul class="list-unstyled components">
						<p>REGISTRASI @IO</p>
						<li class="active">
							<a href="endokrin_v.php">Endokrin</a>
						</li>
						<li>
							<a href="goldar_v.php">Goldar</a>
						</li>
						<li>
							<a href="#">Goldarr</a>
						</li>
					...
					<ul class="list-unstyled CTAs">
						<br><br><br>
						<li><a href="goldar_v.php?page=logout" class="article">Logout</a></li>
...
<table class="table table-bordered" id="myTable" >
  ...
  <?php
    ...
    $nomor=0;
    $query_mysql = mysql_query("SELECT * FROM goldar ORDER BY no ASC")or die(mysql_error());
