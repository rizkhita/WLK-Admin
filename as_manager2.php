			...
			<div class="wrapper">
				...
				<nav id="sidebar">
					...
					<ul class="list-unstyled CTAs">
						<br><br><br>
						<li><a href="as_manager2.php?page=logout" class="article">Logout</a></li>
...
<table>
<form action="as_manager2.php" method="post">
...
$tanggal2=$_POST['tanggal2'];
    $nomor=0;
    $query_mysql = mysql_query("SELECT * FROM goldar where tgl BETWEEN '$tanggal' AND '$tanggal2'")or die(mysql_error());
...
<td><a href="view3.php?no=<?php echo $no?>"><button>Cetak</button></a>
	<a href="goldar_e.php?no=<?php echo $no?>"><button>Edit</button></a>
</td>
</tr>
    <?php
}
