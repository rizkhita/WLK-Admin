			...
			<div class="wrapper">
				...
				<nav id="sidebar">
					...
					<ul class="list-unstyled CTAs">
						<br><br><br>
						<li><a href="edit_manager.php?page=logout" class="article">Logout</a></li>
...
<?php 
  ...
  $query_mysql = mysql_query("SELECT * FROM manager WHERE id_manager='$id_manager'")or die(mysql_error());
...
<td>
    <div class="form-group">
      <label >Nama:</label>
      <input  type="hidden"value="<?php echo $id_manager?>" type="text" name="id_manager" class="form-control" style="width:300px;">
    ...
    <div class="form-group">
      <label >Bagian:</label>
      <input value="<?php echo $data['penda']?>" type="text" name="penda" class="form-control" style="width:300px;">
    </div>
  <br>
</td>
<td style="width:70px;"></td>
<td>
    ...
    <div class="form-group">
  	...
  	<br>
  		<input  name="managern" style="width:150px;text-align:center;" type="submit" class="btn btn-primary">
  	</input>
